...
def challenge6(identifier6):
    ...
    try:
        ...
        while True:
            ...
            thread = threading.Thread(target=handle, args=(child_sock,))#start_new_thread(handle, (child_sock, n))
            thread.start()
            thread.join()
    except socket.timeout:
        pass
...
def handle (child_sock, url = 'https://uclm-arco.github.io/ietf-clone/rfc'):
